...
/* ---------- Data helpers for smooth tooltip ---------- */
...
const RateCharts: React.FC<Props> = ({ series, className }) => {
    ...
    // Sample every 1% so tooltip follows mouse smoothly
    ...
    return (
        <div className={className ?? ''}>
            <div className="rounded-2xl border p-4 shadow-sm">
                {/* Right buffer area for legends (outside plot) */}
                <div className="relative h-96 pr-[220px]">
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={mergedData} margin={{ top: 12, right: 12, bottom: 12, left: 12 }}>
                            ...
                            {/* 4 lines: Borrow solid, Lend dashed, for both rows */}
